    ...
    `<!DOCTYPE html>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #66a181;">
            ...
            <td align="center" style="padding: 20px;">
                <!-- Contenedor principal: ancho máximo 600px, fondo blanco, bordes redondeados, sombra -->
                ...
                <tr>
                    ...
                    <h1 style="color: #333333; text-align: center; margin-top: 0; font-size: 24px;">Gracias por registrarte</h1>
                    
                    <p style="color: #666666; line-height: 1.6;">Hola <strong>${email}</strong>,</p>
                    
                    <p style="color: #666666; line-height: 1.6;">Solamente debemos verificar tu correo. A continuación se te presenta el codigo de verificación. Favor de digitarlo para completar el proceso</p>
