                    ...
                    <div className="p-0 flex flex-col rounded-xl">
                        <div className="flex flex-row p-2 rounded-xl items-center justify-between" style={{ backgroundColor: "var(--green_7F9E7A)", borderBottomLeftRadius: '0px', borderBottomRightRadius: '0px'}}>
                            <div className="p-2 rounded-full" style={{ backgroundColor: "var(--green_CFD9C7)"}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24" fill="#455942" stroke="#455942" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/></svg>
                            </div>
                            <h2 className="text-white text-2xl">Carrito de compra</h2>
                        </div>
                        <div className="ResumenCarrito rounded-xl flex flex-col p-0">
                            {cargando ? (
                                <p className="text-center p-4 text-sm">Cargando carrito...</p>
                            ) : productos.length === 0 ? (
                                <p className="text-center p-4 text-sm">No hay productos en el carrito.</p>
                            ) : (
                                productos.map((item, index) => (
                                    <div className="text-white" key={index}>
                                        <div className="flex flex-row text-xs justify-between p-3">
                                            <p>
                                                {item.productId?.name || "Producto"} - {item.quantity} {item.quantity > 1 ? "unidades" : "unidad"}
                                            </p>
