    ...
    return (
        <main className="flex flex-col p-8 h-full min-h-screen gap-5" style={{ background: "var(--green_CFD9C7)" }}>
            ...
            <div className="flex flex-row gap-10 grid grid-cols-3">
                <section>
                    <div class="w-full mx-auto rounded-2xl bg-[#84A37E] p-6 text-white shadow-lg relative overflow-hidden">
                        <div class="w-10 h-10 flex items-center justify-center bg-white/20 rounded-lg mb-4">
