 ...
 *     aquí toda la tarjeta es pulsable hacia `tienda/[id]`, que ya existe como stub.
 */
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.welcomeCard}>
          ...
          <Link href="/(client)/perfil" style={styles.pillButton}>
            Mi perfil
          </Link>
        </View>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.productRow}>
            {PRODUCTOS_MOCK.map((producto) => (
              <Pressable
                ...
                onPress={() => router.push(`/(client)/tienda/${producto.id}`)}>
        ...
        <Pressable
          ...
          onPress={() => router.push('/(client)/gimnasios')}>
